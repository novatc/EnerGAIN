...
df = pd.read_csv('../data/original/Realisierter_Stromverbrauch_201810010000_202301012359_Stunde.csv', sep=';')
...
df.to_csv('../data/clean/energy_consumption_01102018_01012023.csv', index=False)